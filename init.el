...
It should only modify the values of Spacemacs settings."
  ...
  ;; spacemacs settings.
  (setq-default
   ;; If n on-nil ELPA repositories are contacted via HTTPS whenever it's
   ;; possible. Set it to nil if you have no way to use HTTPS in your
   ;; environmennt, otherwise it is strongly recommended to let it set to t.
   ;; This variable has no effect if Emacs is launched with the parameter
   ;; `--insecure' which forces the value of this variable to nil.
   ;; (default t)
   dotspacemacs-elpa-https t
   ;; Maximum allowed time inn seconds to contact an ELPA repository.
...
(custom-set-variables
 ...
 '(package-selected-packages (quote (org-plus-contrib evil-unimpaired))))
(custom-set-faces
